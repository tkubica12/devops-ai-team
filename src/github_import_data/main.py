...
COSMOS_ISSUES_CONTAINER_NAME = "issues"
...
cosmos_issues_container = cosmos_database.get_container_client(COSMOS_ISSUES_CONTAINER_NAME)
...
github_importer = GitHubImporter(
    ...
    cosmos_issues_container=cosmos_issues_container
)
